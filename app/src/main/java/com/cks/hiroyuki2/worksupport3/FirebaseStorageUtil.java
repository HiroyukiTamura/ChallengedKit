...
import static com.cks.hiroyuki2.worksupport3.Fragments.ShareBoardFragment.URL_SHORTEN_API;
 ...
 * このおじさんはUtilクラスなので、描画やら何やらは全部{@link ShareBoardFragment}側でやってください。
 * おじさんは裏方！
 */
...
public class FirebaseStorageUtil implements OnPausedListener, OnProgressListener{
    ...
    public void onSuccessShortenUrl(Uri uri, Callback callback){
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .build();
        Request request = new Request.Builder().url(URL_SHORTEN_API).post(requestBody).build();
